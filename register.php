...
<body>
    <div class="register-container">
        ...
        <form method="POST" action="app/register_process.php" id="registerForm">
            <?php
            ...
            <a href="index.php" class="login-link">Đã có tài khoản? Đăng nhập</a>
        </form>

        <div class="footer-text">
            © 2024 Bear System - Hệ thống quản lý nhiệm vụ
        </div>
    </div>
