...
<head>
    ...
    <title>Đăng Nhập | Hệ Thống Quản Lý Nhiệm Vụ</title>
...
<body>
    <div class="login-container">
        ...
        <div class="brand-subtitle">Đăng nhập vào hệ thống :)</div>
        ...
        <form method="POST" action="app/login.php" id="loginForm">
            ...
            <div class="form-group">
                <input type="text" name="user_name" class="form-input" placeholder="bear@gmail.com" required>
            </div>

            <div class="form-group">
                <input type="password" name="password" class="form-input password-input" placeholder="••••••••" id="passwordInput" required>
            ...
            <a href="app/register.php" class="register-link">Chưa có tài khoản? Đăng ký ngay</a>
        </form>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            // Remove loading after 2 seconds (for demo)
            setTimeout(() => {
